...
var _formTs = require("./form.ts");
var _listTs = require("./list.ts");

},{"./form.ts":"dS2u2","./list.ts":"gspjq"}],"dS2u2":[function(require,module,exports,__globalThis) {
var _stateTs = require("../src/state.ts");
var _wallJpg = require("../src/wall.jpg");
class ComponentForm extends HTMLElement {
    ...
    connectedCallback() {
        ...
        form?.addEventListener("submit", (e)=>{
            ...
            (0, _stateTs.state).addItem(input.value);
        });
    }
    render() {
...
},{"../src/state.ts":"1Yeju","../src/wall.jpg":"cS4QE"}],"1Yeju":[function(require,module,exports,__globalThis) {
...
},{}],"cS4QE":[function(require,module,exports,__globalThis) {
module.exports = require("e726142342a97e07").getBundleURL('7UhFu') + "wall.b1df144f.jpg" + "?" + Date.now();

},{"e726142342a97e07":"lgJ39"}],"lgJ39":[function(require,module,exports,__globalThis) {
"use strict";
var bundleURL = {};
...
},{}],"gspjq":[function(require,module,exports,__globalThis) {
var _stateTs = require("../src/state.ts");
class ComponentList extends HTMLElement {
    ...
    deletePostit() {
        ...
        for (const element of deleteImage || []){
            ...
            imgElement?.addEventListener("click", (e)=>{
                e.preventDefault();
                const f = e.target;
                const listOG = (0, _stateTs.state).getState().list;
                const listOG2 = listOG.filter((_, index)=>index !== indexDiv);
                (0, _stateTs.state).setState({
                    "list": listOG2
                });
            });
        }
    ...
    checkStatus() {
        const list = (0, _stateTs.state).getState().list;
...
},{"../src/state.ts":"1Yeju"}]},["cGkjZ","h7u1C"], "h7u1C", "parcelRequire94c2")
