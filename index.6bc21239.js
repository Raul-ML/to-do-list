            ...
            ${e.map(i=>{var s=i[1];return t<e.length&&t++,`
                <div class="postit ${s} ${i[2]}" id="${t}">
                    ...
                    <div class="postit-check-delete">
                        <input type="checkbox">
                        <img class="${i[2]}" src="./del_img.36c7340d.png" alt="del img" width="20px" height="20px">
                    </div>
                </div>
                            `}).join("")}`}}customElements.define("my-list",l);
//# sourceMappingURL=index.6bc21239.js.map
